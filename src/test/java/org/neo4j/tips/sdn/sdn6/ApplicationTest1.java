...
@Slf4j
class ApplicationTest1 extends ApplicationAbstractTest {
...
//    }
    ...
    void getMoviesShouldWork1(@Autowired TestRestTemplate restTemplate) {
    ...
    void postPeopleShouldWork2(@Autowired TestRestTemplate restTemplate, @Autowired Driver driver) {
